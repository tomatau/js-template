...
TomataoReporter.prototype.createDom = function(type, attrs, childrenVarArgs) {
...
TomataoReporter.prototype.reportRunnerStarting = function(runner) {
  this.outerDiv = this.createDom('div', { className: 'jasmine_reporter' },
      this.createDom('h1', { }, "Javascript Tests"),
...
TomataoReporter.prototype.reportRunnerResults = function(runner) {
  ...
  var progress = this.createDom('div', {}, 
      ...
      this.createDom('div', { className: 'completion' }, 
        this.createDom('div', {},
          this.createDom('span', { className: 'key' }, "Modules: "),
          this.createDom('span', { className: 'value' }, this.noOfSubjects - this.failedSubjects + "/" + this.noOfSubjects)
          ),
        this.createDom('div', {},
          this.createDom('span', { className: 'key' }, "Tests: "),
          this.createDom('span', { className: 'value' }, specsCount - this.failedSpecs + "/" + runner.specs().length)
          ),
        this.createDom('div', { className: 'options' },
          this.createDom('label', { "for": "__jsTests_showPassed__" }, " Show passed Tests"),
          showPassed = this.createDom('input', { id: "__jsTests_showPassed__", type: 'checkbox' }),
          this.createDom('label', { "for": "__jsTests_showAllFailed__" }, " Look ahead"),
          showAllFailed = this.createDom('input', { id: "__jsTests_showAllFailed__", type: 'checkbox' })
          )
        )      
      );
...
TomataoReporter.prototype.reportSuiteResults = function(suite) {
...
TomataoReporter.prototype.reportSpecStarting = function(spec) {
};

TomataoReporter.prototype.reportSpecResults = function(spec) {
...
TomataoReporter.prototype.log = function() {
  var console = jasmine.getGlobal().console;
  if (console && console.log) console.log.apply(console, arguments);
};

TomataoReporter.prototype.getLocation = function() {
  return this.document.location;
};

TomataoReporter.prototype.specFilter = function(spec) {
  var paramMap = {};
...
TomataoReporter.prototype.getSuiteDescription = function(suite) {
  if (null === suite.parentSuite) {
    return "Module: " + suite.description;
  } else {
    return "Module: " + suite.description;
  }
};
